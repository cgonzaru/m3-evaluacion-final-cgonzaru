      ...
      <div className="character-detail">
        ...
        <div className="character-info">
          ...
          <div className="info">
            ...
            <p className="character-status">Status: {status} {(status === 'Dead') ? <i className="fas fa-dizzy"></i> : ''}</p>
            <p className="character-status">Species: {species} {(species === 'Human') ? <i className="fas fa-user"></i> : <i class="fab fa-reddit-alien"></i>}</p>
            <p className="character-status">Origin: {origin.name}</p>
            <p className="character-status">Episodes: {episode.length} {(episode.length > 0) ? <i className="fas fa-tv"></i> : ''}</p>
          </div>
        </div>
      </div>
    );
